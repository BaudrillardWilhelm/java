...
public class OrderDaoImpl implements OrderDao {
    ...
    public Order getOrderByUidOid(int uid,int oid) {
        Connection con = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        Order order = null;
        ...
        try {
            con = DatabaseUtil.getConnection();
            ps = con.prepareStatement("SELECT * FROM orders WHERE uid = ?  and oid = ? ORDER BY order_date DESC;");
            ps.setInt(1, uid);
            ps.setInt(2,oid);
            rs = ps.executeQuery();
     ...
     * @return
     */
    public int ReturnOrder(int uid, int oid) {
        Connection con = null;
        PreparedStatement ps = null;
        int rowsAffected = 0;
        ...
        try {
            con = DatabaseUtil.getConnection();
            ps = con.prepareStatement("Update orders set order_type = -1 where uid = ? and oid = ?");
            ps.setInt(1, uid);
            ps.setInt(2, oid);
     ...
     * @return
     */
    public int ConfirmReceivedOrder(int uid, int oid) {
        Connection con = null;
        PreparedStatement ps = null;
        int rowsAffected = 0;
    ...
    public int clearOrder(int uid) {
        ...
        try {
            con = DatabaseUtil.getConnection();
            ps = con.prepareStatement("DELETE FROM orders WHERE uid = ? ");
            ps.setInt(1, uid);
    ...
    public List<Order> getRatedOrderList(int uid) {
        Connection con = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        List<Order> orderList = new ArrayList<>();
        ...
        try {
            con = DatabaseUtil.getConnection();
            ps = con.prepareStatement("select o.* from rate  r , orders o where r.uid = o.uid and o.uid =?;");
            ps.setInt(1, uid);
            rs = ps.executeQuery();
