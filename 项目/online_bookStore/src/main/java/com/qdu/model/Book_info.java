...
public class Book_info {
    ...
    public Book_info(int bid, String b_name, double b_price, int b_num, String b_imgpath, int type_id, String publisher, Date b_time, int rate_number, String author, Date storage_time, String b_info, double discount) {
        this.bid = bid;
        this.b_name = b_name;
    ...
    public void setRateNumber(int rate_number) {
        this.rate_number = rate_number;
    }
