...
@WebServlet("/UserManagerChangeAnswerServlet")
public class UserManagerChangeAnswerServlet  extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String Answer=mreq.getParameter("g");
        UserDaoImpl uo = new UserDaoImpl();
        uo.ChangeQuestion(uid, Answer);
