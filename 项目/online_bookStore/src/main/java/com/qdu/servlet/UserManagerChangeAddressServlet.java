...
@WebServlet("/UserManagerChangeAddressServlet")
public class UserManagerChangeAddressServlet  extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String Address=mreq.getParameter("g");
        UserDaoImpl uo = new UserDaoImpl();
        uo.ChangeAddress(uid, Address);
