...
@WebServlet("/UserManagerChangeQuestionServlet")
public class UserManagerChangeQuestionServlet  extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String Question=mreq.getParameter("g");
        UserDaoImpl uo = new UserDaoImpl();
        uo.ChangeQuestion(uid, Question);
