...
@WebServlet("/UserManagerChangeE_mailServlet")
public class UserManagerChangeE_mailServlet  extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String E_mail=mreq.getParameter("g");
        UserDaoImpl uo = new UserDaoImpl();
        uo.ChangeE_mail(uid, E_mail);
